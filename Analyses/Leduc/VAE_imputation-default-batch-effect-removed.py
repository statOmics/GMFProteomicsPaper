...
with open('Output_batch_effect_removal/time_measurement_VAE_default_batch_removed.txt', 'w') as file:
    file.write(f"Elapsed time: {elapsed_time} seconds\n")
    
df_imputed.to_csv("Output_batch_effect_removal/VAE_default_batch_removed_sce.csv")
...
for x in range(1,11):
    ...
    df_imputed.to_csv("Output_batch_effect_removal/VAE_default_batch_removed_MISTOT10_MNAR25_" + str(x) + ".csv")
...
for x in range(1,11):
    ...
    df_imputed.to_csv("Output_batch_effect_removal/VAE_default_batch_removed_MISTOT10_MNAR50_" + str(x) + ".csv")
...
for x in range(1,11):
    ...
    df_imputed.to_csv("Output_batch_effect_removal/VAE_default_batch_removed_MISTOT10_MNAR75_" + str(x) + ".csv")
