...
for(i in c("25","50","75")){
  for(j in c(1:10)){
  original <- readRDS(file =  here("Data","Petrosius", "petrosius_sce.RDS"))
  NAs <- readRDS(file  =  here("Data","Petrosius", paste0("petrosius_MISTOT10_MNAR", i, "_", j, ".RDS")))
  original <- original[rowMeans(is.na(NAs$data)) < 1 ,]
    
  sgd <- readRDS(file = here("Analyses","Petrosius", "Output", 
                             paste0("sgd_MISTOT10_MNAR", i, "_", j, ".RDS")))
  
  sgd_batch <- readRDS(file = here("Analyses","Petrosius", "Output", 
  ...
  DAE <- as.matrix(data.table::fread(file = here("Analyses","Petrosius", "Output", 
                              paste0("DAE_MISTOT10_MNAR", i, "_", j,".csv")),
                  header = "auto"), rownames = 1)
  DAE_default <- as.matrix(data.table::fread(file = here("Analyses","Petrosius", "Output", 
                              paste0("DAE_default_MISTOT10_MNAR", i, "_", j,".csv")),
                  header = "auto"), rownames = 1)
  
  CF <- as.matrix(data.table::fread(file = here("Analyses","Petrosius", "Output", 
                              paste0("CF_MISTOT10_MNAR", i, "_", j,".csv")),
                  header = "auto"), rownames = 1)
  CF_default <- as.matrix(data.table::fread(file = here("Analyses","Petrosius", "Output", 
                              paste0("CF_default_MISTOT10_MNAR", i, "_", j,".csv")),
                  header = "auto"), rownames = 1)
  
  VAE <- as.matrix(data.table::fread(file = here("Analyses","Petrosius", "Output", 
                              paste0("VAE_MISTOT10_MNAR", i, "_", j,".csv")),
                  header = "auto"), rownames = 1)
  VAE_default <- as.matrix(data.table::fread(file = here("Analyses","Petrosius", "Output", 
                              paste0("VAE_default_MISTOT10_MNAR", i, "_", j,".csv")),
                  header = "auto"), rownames = 1)
  
  nipals <- readRDS(file = here("Analyses","Petrosius", "Output",
                              paste0("nipals_MISTOT10_MNAR", i, "_", j,".RDS")))
  nipals_reconstructed <- reconstruct_nipals(nipals)
  

  knnmethod <- readRDS(file = here("Analyses","Petrosius", "Output", 
                              paste0("knnmethod_MISTOT10_MNAR", i, "_", j,".RDS")))
  
  qrilc <- readRDS(file = here("Analyses","Petrosius", "Output", 
                              paste0("qrilc_MISTOT10_MNAR", i, "_", j, ".RDS")))

  zero <- readRDS(file = here("Analyses","Petrosius", "Output", 
                              paste0("zero_MISTOT10_MNAR", i, "_", j,".RDS")))
  
  minimum <- readRDS(file = here("Analyses","Petrosius", "Output",  
  ...
  methods <- list(sgd_reconstructed, 
                  ...
                  DAE, VAE, CF, DAE_default, VAE_default, CF_default, 
...
saveRDS(object = df_all, file = here("Analyses","Petrosius", "Output", "imputation_results_Petrosius.RDS"))
