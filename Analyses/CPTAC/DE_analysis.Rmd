...
# In this script 2 fixed effects are included, one for each lab. 
...
# 2 fixed effects for labs were used.
...
write.xlsx(results_fdp1, file= here("Figures/Supplementary_Data_FDP_control.xlsx"), 
           sheetName="DE_3labs_fdp_0.01", row.names=TRUE)
write.xlsx(results_fdp5, 
           file=here("Figures/Supplementary_Data_FDP_control.xlsx"), 
           sheetName="DE_3labs_fdp_0.05", append=TRUE, row.names=TRUE)
write.xlsx(results_fdp10, 
           file=here("Figures/Supplementary_Data_FDP_control.xlsx"), 
           sheetName="DE_3labs_fdp_0.10", append=TRUE, row.names=TRUE)
...
# Add new worksheet
addWorksheet(wb, "Supp_fig_37")

# Write data
writeData(wb, "Supp_fig_37", excel_supp_fig_37)
...
# Add new worksheet
addWorksheet(wb, "Supp_fig_38")

# Write data
writeData(wb, "Supp_fig_38", excel_supp_fig_38)
