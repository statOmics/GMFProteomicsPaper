...
```{r}
saveRDS(object = sgd, file = here("Analyses","Leduc","Output","sgd_sce.RDS"))
saveRDS(time_diff, file = here("Analyses","Leduc","Output","sgd_time.RDS"))
```
...
for(i in c(1:10)){
  ...
  saveRDS(object = sgd_10_25, file = paste0(here("Analyses","Leduc","Output"),"/sgd_MISTOT10_MNAR25_", i, ".RDS"))
  ...
  saveRDS(object = sgd_10_50, file = paste0(here("Analyses","Leduc","Output"),"/sgd_MISTOT10_MNAR50_", i, ".RDS"))
  ...
  saveRDS(object = sgd_10_75, file = paste0(here("Analyses","Leduc","Output"),"/sgd_MISTOT10_MNAR75_", i, ".RDS"))
