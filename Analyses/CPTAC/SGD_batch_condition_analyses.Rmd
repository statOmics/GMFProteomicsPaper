...
# Define the design: 2 fixed effects for the different labs and 4 fixed effects
# for the different spike-in conditions.
...
# /Data/CPTAC_data.Rmd. 2 fixed effects are included for the different labs and 
# 4 fixed effects for the different spike-in conditions.
...
```{r}
saveRDS(object = sgd, file = here("Analyses","CPTAC","Output","sgd_batch_condition_sce.RDS"))
saveRDS(time_diff, file = here("Analyses","CPTAC","Output","sgd_batch_condition_time.RDS"))
```
...
# 2 fixed effects are considered to account for lab and 4 fixed effects for the different spike in conditions. 
...
for(i in c(1:10)){
  ...
  saveRDS(object = sgd_10_25, file = paste0(here("Analyses","CPTAC","Output"),"/sgd_batch_condition_MISTOT10_MNAR25_", i, ".RDS"))
  ...
  saveRDS(object = sgd_10_50, file = paste0(here("Analyses","CPTAC","Output"),"/sgd_batch_condition_MISTOT10_MNAR50_", i, ".RDS"))
  ...
  saveRDS(object = sgd_10_75, file = paste0(here("Analyses","CPTAC","Output"),"/sgd_batch_condition_MISTOT10_MNAR75_", i, ".RDS"))
