...
begin_time <- Sys.time()
family <- gaussian()
sgd <-  calculateGMF(sce, family = family, X = X,
...
```{r}
saveRDS(object = sgd, file = here("Analyses","Petrosius","Output","sgd_batch_sce.RDS"))
saveRDS(time_diff, file = here("Analyses","Petrosius","Output","sgd_batch_time.RDS"))
```
...
for(i in c(1:10)){
  ...
  sgd_10_25 <-  calculateGMF(sce, family = family, exprs_values = "MISTOT10_MNAR25", X = X, 
                             control.alg = list(tol = 0.001, maxiter = 10000),
                             ncomponents = 4)
  
  saveRDS(object = sgd_10_25, file = paste0(here("Analyses","Petrosius","Output"),"/sgd_batch_MISTOT10_MNAR25_", i, ".RDS"))
  ...
  saveRDS(object = sgd_10_50, file = paste0(here("Analyses","Petrosius","Output"),"/sgd_batch_MISTOT10_MNAR50_", i, ".RDS"))
  ...
  saveRDS(object = sgd_10_75, file = paste0(here("Analyses","Petrosius","Output"),"/sgd_batch_MISTOT10_MNAR75_", i, ".RDS"))
