...
```{r}
saveRDS(object = sce, file = here("Data","CPTAC_nolab1","CPTAC_sce.RDS"))
write.csv(x = assay(sce,"logintensities"), file = here("Data","CPTAC_nolab1","CPTAC_sce.csv"))
```
...
for(i in c(1:10)){
  ...
  saveRDS(MISTOT10_MNAR25, paste0(here("Data","CPTAC_nolab1"), "/CPTAC_MISTOT10_MNAR25_",i,".RDS"))
  saveRDS(MISTOT10_MNAR50, paste0(here("Data","CPTAC_nolab1"), "/CPTAC_MISTOT10_MNAR50_",i,".RDS"))
  saveRDS(MISTOT10_MNAR75, paste0(here("Data","CPTAC_nolab1"), "/CPTAC_MISTOT10_MNAR75_",i,".RDS"))

  write.csv(x = MISTOT10_MNAR25$data[rowMeans(is.na(MISTOT10_MNAR25$data)) < 1,], 
            file = paste0(here("Data","CPTAC_nolab1"), "/CPTAC_MISTOT10_MNAR25_",i,".csv"))
  write.csv(x = MISTOT10_MNAR50$data[rowMeans(is.na(MISTOT10_MNAR50$data)) < 1,], 
            file = paste0(here("Data","CPTAC_nolab1"), "/CPTAC_MISTOT10_MNAR50_",i,".csv"))
  write.csv(x = MISTOT10_MNAR75$data[rowMeans(is.na(MISTOT10_MNAR75$data)) < 1,], 
            file = paste0(here("Data","CPTAC_nolab1"), "/CPTAC_MISTOT10_MNAR75_",i,".csv"))
}
```
