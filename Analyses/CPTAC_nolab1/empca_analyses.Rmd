...
df <- empca(data, center = FALSE, scale = F, ncomp = 4, 
...
saveRDS(object = df, file = paste0(here("Analyses/CPTAC_nolab1/Output/"),"empca_sce.RDS"))
saveRDS(object = time_difference, 
        file = paste0(here("Analyses/CPTAC_nolab1/Output/"),"empca_time.RDS"))
...
for(i in c(1:10)){
  ...
  saveRDS(object = df, file = paste0(here("Analyses","CPTAC_nolab1","Output"),"/empca_MISTOT10_MNAR25_", i, ".RDS"))
...
for(i in c(1:10)){
  ...
  saveRDS(object = df, file = paste0(here("Analyses","CPTAC_nolab1","Output"),"/empca_MISTOT10_MNAR50_", i, ".RDS"))
...
for(i in c(1:10)){
  ...
  saveRDS(object = df, file = paste0(here("Analyses","CPTAC_nolab1","Output"),"/empca_MISTOT10_MNAR75_", i, ".RDS"))
